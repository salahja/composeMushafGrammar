...
open class AnnotatedQuranMorphologyDetails(
...
//    wordbdetail.put("form", AnnotatedString("I"));
            ...
            if (corpusNoun!!.size > 0) {
                if (corpusNoun!![0].proptwo.equals(CorpusConstants.NominalsProp.PCPL)) {
                    ...
                    if (mform != "I") {
                        ...
                        wordbdetail["form"] =
                            AnnotatedString(corpusNoun!![0].form!!)
                    }
        ...
        if (corpusNoun!!.size > 0) {
            if (corpusNoun[0].tag == "PN" || corpusNoun[0].tag == "ADJ") {
                ...
                if (form != "null") {
                    ...
                    wordbdetail["formnumber"] = AnnotatedString(form!!)
                }
                if (propone != "null" && proptwo != "null") {
                    if ((pcpl == "ACTPCPL")) {
        ...
        if (corpusSurahWord.size > 0) {
            if (corpusSurahWord[0].corpus.wordcount === 1) {
                if (corpusSurahWord[0].corpus.rootaraone!!.isNotEmpty()) {
                    wordbdetail["root"] =
                        AnnotatedString(corpusSurahWord[0].corpus.rootaraone!!)
                }
                ...
                if (corpusSurahWord[0].corpus.rootaraone!!.isNotEmpty()) {
                    ...
                    wordbdetail["root"] =
                        AnnotatedString(corpusSurahWord[0].corpus.rootaratwo!!)
                }
                ...
                if (corpusSurahWord[0].corpus.rootaraone!!.isNotEmpty()) {
                    ...
                    wordbdetail["root"] =
                        AnnotatedString(corpusSurahWord[0].corpus.rootarathree!!)
                }
                ...
                if (corpusSurahWord[0].corpus.rootaraone!!.isNotEmpty()) {
                    ...
                    wordbdetail["root"] =
                        AnnotatedString(corpusSurahWord[0].corpus.rootarafour!!)
                }
                ...
                if (corpusSurahWord[0].corpus.rootaraone!!.isNotEmpty()) {
                    ...
                    wordbdetail["root"] =
                        AnnotatedString(corpusSurahWord[0].corpus.rootarafive!!)
                }
            }
        }
    }
    ...
    private fun GetLemmArabicwordWordDetails(
        ...
        if (corpusSurahWord[0].corpus.wordcount === 1) {
            ...
            wordbdetail["lemma"] =
                AnnotatedString(corpusSurahWord[0].corpus.lemaraone!!)
            val spannableString = AnnotationUtility.AnnotatedWordSpan(tagone, "", "", "", "", araone, "", "", "", "")
            val tagspannables =
            ...
            val arabicspannable = AnnotatedString(
                araone + aratwo
            )
            val expandTagsone = expandTags(tagone)
