...
/**
 * Tooltips implementation for AndroidX Jetpack Compose.
 * Based on material [DropdownMenu] implementation
 *
 * A [Tooltips] behaves similarly to a [Popup], and will use the position of the parent layout
 * to position itself on screen. Commonly a [Tooltips] will be placed in a [Box] with a sibling
 * that will be used as the 'anchor'. Note that a [Tooltips] by itself will not take up any
 * space in a layout, as the Tooltips is displayed in a separate window, on top of other content.
 *
 * The [content] of a [Tooltips] will typically be [Text], as well as custom content.
 *
 * [Tooltips] changes its positioning depending on the available space, always trying to be
 ...
 *
 * @param expanded Whether the Tooltips is currently visible to the user
 * @param offset [DpOffset] to be added to the position of the Tooltips
 *
...
/**
 * Simple text version of [Tooltips]
 */
/*
@Composable
fun Tooltips(
...
private fun TooltipContent(
    ...
    // Tooltips open/close animation.
    val transition = updateTransition(expandedStates, "Tooltips")
...
/**
 * How to show a Tooltips in AndroidX Jetpack Compose on long click.
 * Usage example.
 */
@Composable
@OptIn(ExperimentalFoundationApi::class)
fun TooltipOnLongClickExample(onClick: () -> Unit = {}) {
    // Commonly a Tooltips can be placed in a Box with a sibling
    ...
    Box {
        ...
        Box(
            ...
            Text("Click Me (will show Tooltips on long click)")
        }

        Tooltips(showTooltip) {
            // Tooltips content goes here.
            Text("Tooltips Text!!")
        }
    }
}