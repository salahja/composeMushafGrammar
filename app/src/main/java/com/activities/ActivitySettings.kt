...
import com.android.audiomushaf.ThemeListPrefrence
...
class ActivitySettings : BaseActivity(),
    ...
    override fun getIntent(): Intent {
        ...
        val readingintent = Intent(this, ShowMushafActivity::class.java)
    ...
    if (pref.key == "themepref") {
            ...
            ThemeListPrefrence.newInstance()
                .show(this@ActivitySettings.supportFragmentManager,"tag")
            title = pref.title
